...
class EventsCalendarPage extends StatefulWidget {
  final VoidCallback? onRefresh; // Add this to handle refresh from parent
  const EventsCalendarPage({Key? key, this.onRefresh}) : super(key: key);
...
// Add this method for delete confirmation
  ...
  Widget _buildEventsList() {
    return _getEventsForDay(_selectedDay!).isEmpty
        ? Center(
            child: Column(
